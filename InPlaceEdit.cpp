...
// Construction
CInPlaceEdit::CInPlaceEdit(int iItem, int iSubItem, CString sInitText, CEditableListCtrl* parent) :m_sInitText(sInitText )
{
	m_iItem = iItem;
	m_iSubItem = iSubItem;
	m_bESC = FALSE;
...
{	
	...
	m_parent->OnSetLabelText(m_iItem, m_iSubItem,str);
	DestroyWindow();
}
